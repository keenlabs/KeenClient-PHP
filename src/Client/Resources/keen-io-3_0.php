...
return array(
    ...
    'operations' => array(
        ...
        'createProject' => array(
            ...
            'description' =>
                'Creates a project for the specified organization and returns the project id for later usage.',
            'httpMethod' => 'POST',
            'parameters' => array(
        ...
        'getProjects' => array(
            'uri' => 'projects',
            'description' =>
                'Returns the projects accessible to the API user, as well as' .
        ...
        'getSavedQuery' => array(
            ...
            'description' =>
                'Returns the detailed information about the specified query, as well as links to retrieve results.',
            'httpMethod' => 'GET',
            'parameters' => array(
                'projectId' => array(
                    'location' => 'uri',
        ...
        'addEvents' => array(
            'uri' => 'projects/{projectId}/events',
            'description' =>
                'POST inserts multiple events in one or more collections, in a single request.' .
                ' The API expects a JSON object whose keys are the names of each event collection you want to' .
                ' insert into. Each key should point to a list of events to insert for that event collection.',
            'httpMethod' => 'POST',
            'parameters' => array(
                'projectId' => array(
                    'location' => 'uri',
        ...
        'deleteEvents' => array(
            'uri' => 'projects/{projectId}/events/{event_collection}',
            'description' =>
                'DELETE one or multiple events from a collection. You can optionally add' .
                ' filters, timeframe or timezone. You can delete up to 50,000 events using one method call',
            'httpMethod' => 'DELETE',
            'parameters' => array(
                'projectId' => array(
                    'location' => 'uri',
                ...
                'filters' => array(
                    'location' => 'query',
                    'description' =>
                        'Filters are used to narrow down the events used in' .
        ...
        'deleteEventProperties' => array(
            'uri' => 'projects/{projectId}/events/{event_collection}/properties/{property_name}',
            'description' =>
                'DELETE one property for events. This only works for properties with less than 10,000 events.',
            'httpMethod' => 'DELETE',
            'parameters' => array(
                'projectId' => array(
                    'location' => 'uri',
        ...
        'count' => array(
            ...
            'parameters' => array(
                ...
                'interval' => array(
                    'location' => 'json',
                    'description' =>
                        'Intervals are used when creating a Series API call.' .
                ...
                'group_by' => array(
                    'location' => 'json',
                    'description' =>
                        'The group_by parameter specifies the name of a property' .
                        ' by which you would like to group the results.',
                    'type' => array('string', 'array'),
                    'filters' => array('KeenIO\Client\Filter\MultiTypeFiltering::encodeValue'),
                    'required' => false,
                ),
        ...
        'countUnique' => array(
            ...
            'description' =>
                ...
                ' The response will be a simple JSON object with one key: result,' .
        ...
        'minimum' => array(
            ...
            'description' =>
                'GET returns the minimum numeric value for the target property in the event collection matching' .
                ' the given criteria. Non-numeric values are ignored. The response will be a simple JSON object' .
                ' with one key: result, which maps to the numeric result described previously.',
            'httpMethod' => 'POST',
            'parameters' => array(
                'projectId' => array(
                    'location' => 'uri',
        ...
        'maximum' => array(
            ...
            'description' =>
                'GET returns the maximum numeric value for the target property in the event collection matching' .
                ' the given criteria. Non-numeric values are ignored. The response will be a simple JSON object' .
                ' with one key: result, which maps to the numeric result described previously.',
            'httpMethod' => 'POST',
            'parameters' => array(
        ...
        'average' => array(
            ...
            'description' =>
                'GET returns the average across all numeric values for the target property in the event collection' .
                ' matching the given criteria. Non-numeric values are ignored. The response will be a simple JSON ' .
        ...
        'sum' => array(
            ...
            'description' =>
                'GET returns the sum if all numeric values for the target property in the event collection matching' .
                ' the given criteria. Non-numeric values are ignored. The response will be a simple JSON object with' .
                ' one key: result, which maps to the numeric result described previously.',
            'httpMethod' => 'POST',
            'parameters' => array(
                'projectId' => array(
                    'location' => 'uri',
        ...
        'selectUnique' => array(
            ...
            'description' =>
                ...
                ' The response will be a simple JSON object with one key: result, which maps to an array of' .
        ...
        'multiAnalysis' => array(
            ...
            'description' =>
                'Multi-analysis lets you run multiple types of analysis over the same data.' .
            ...
            'parameters' => array(
                ...
                'analyses' => array(
                    'location' => 'json',
                    'description' =>
                        'A URL encoded JSON object that defines the multiple types of analyses to perform.',
                    'type' => 'array',
                    'required' => true,
                ),
                'filters' => array(
        ...
        'extraction' => array(
            ...
            'description' =>
                ...
                ' The email will include a link to a downloadable CSV file. If email is omitted, then the' .
                ' extraction will be processed in-line and JSON results will be returned in the GET request.',
            'httpMethod' => 'POST',
            'parameters' => array(
                'projectId' => array(
                    'location' => 'uri',
                ...
                'property_names' => array(
                    'location' => 'json',
                    'description' =>
                        'A URL-encoded array of strings containing properties you wish to extract.' .
        ...
        'median' => array(
            ...
            'description' =>
                'GET returns the median across all numeric values for the target property in the event collection' .
                ' matching the given criteria. Non-numeric values are ignored. The response will be a simple JSON' .
                ' object with one key: result, which maps to the numeric result described previously.',
            'httpMethod' => 'POST',
            'parameters' => array(
        ...
        'percentile' => array(
            ...
            'description' =>
                'GET returns the Xth percentile value across all numeric values for the target property in the event' .
                ' collection matching the given criteria. Non-numeric values are ignored. The response will be a' .
                ' simple JSON object with one key: result, which maps to the numeric result described previously.',
            'httpMethod' => 'POST',
            'parameters' => array(
                'projectId' => array(
                    'location' => 'uri',
